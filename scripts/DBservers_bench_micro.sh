...
#    memory_line_all=$(sed -n '2p' conf_file_all)
    ...
    do
      ...
      ssh -o StrictHostKeyChecking=no $ip "killall microbench > /dev/null 2>&1 && cd $BIN_HOME"
      j=$((j+1))
  #		if [ $j = $node ]; then
  #			break;
  #		fi
    ...
    j=0
      ...
      do
        ...
        ssh -o StrictHostKeyChecking=no $ip "killall MemoryServer > /dev/null 2>&1 && cd $BIN_HOME"
        j=$((j+1))
  #  		if [ $j = $node ]; then
  #  			break;
  #  		fi
    ...
    do
      ...
      rsync -vz /home/wang4996/ScaleStore/connection.conf ${memory_nodes[$i]}:/home/wang4996/ScaleStore/connection.conf
      i=$((i+1))
    done
    i=0
    ...
    do
      ...
      rsync -vz /home/wang4996/ScaleStore/connection.conf ${compute_nodes[$i]}:/home/wang4996/ScaleStore/connection.conf
      i=$((i+1))
    done
    i=0
...
#        fi
        ...
        ibip="192.168.100.$((i+$memory_num+1))"
