...
const std::vector<std::vector<std::string>> NODES{
        {""},                                                                                              // 0 to allow direct offset
        {"192.168.100.1"},                                                                                  // 1
        {"192.168.100.1", "192.168.100.2"},                                                                  // 2
        {"192.168.100.1", "192.168.100.2", "192.168.100.3"},                                                  // 3
        {"192.168.100.1", "192.168.100.2", "192.168.100.3", "192.168.100.4"},                                  // 4
        {"192.168.100.1"},                                                                                  // 1
        {"192.168.100.1", "192.168.100.2"},                                                                  // 2
        {"192.168.100.1", "192.168.100.2", "192.168.100.3"},                                                  // 3
        {"192.168.100.1", "192.168.100.2", "192.168.100.3", "192.168.100.4","192.168.100.5", "192.168.100.6", "192.168.100.7", "192.168.100.8","192.168.100.9", "192.168.100.10", "192.168.100.11", "192.168.100.12","192.168.100.13", "192.168.100.14", "192.168.100.15", "192.168.100.16"}
};
