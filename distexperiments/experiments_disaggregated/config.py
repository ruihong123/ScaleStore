...
server_list = ServerList(
    ...
    Server('node-0', '10.145.21.34', SERVER_PORT, ssdPath="~/ScaleStore/distexperiments/SSDData/DATA/file.txt"),
    Server('node-1', '10.145.21.35', SERVER_PORT, ssdPath="~/ScaleStore/distexperiments/SSDData/DATA/file.txt"),


    # memory nodes fill in
    Server('node-2', '10.145.21.36', SERVER_PORT, ssdPath="~/ScaleStore/distexperiments/SSDData/DATA/file.txt"),
    Server('node-3', '10.145.21.39', SERVER_PORT, ssdPath="~/ScaleStore/distexperiments/SSDData/DATA/file.txt"),
