...
def compile(servers):
    servers.cd("/home/wang4996/ScaleStore/build")
    cmake_cmd = f'cmake -D CMAKE_C_COMPILER=gcc -D CMAKE_CXX_COMPILER=g++ -DCMAKE_BUILD_TYPE=Debug -DSANI=OFF ..'
...
def ycsbBenchmark(servers, dramGBCompute, dramGBMemory, ssdGBCompute, ssdGBMemory, numberNodes, zipf,probSSD, pp,fp,partitioned,RUNS):
